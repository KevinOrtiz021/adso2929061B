            ...
            <div class="card-body">
                ...
                <ul class="list bg-[#0003] rounded-box shadow-md">
                    ...
                    <li class="list-row">
                        ...
                        <button class="btn btn-square btn-ghost">
                            {{ App\Models\Pet::where('kind', 'Perro')->count() }}
                        </button>
                    </li>
                    <li class="list-row">
                        <div>
                        ...
                        <button class="btn btn-square btn-ghost">
                            {{ App\Models\Pet::where('kind', 'Gato')->count() }}
                        </button>
                    </li>
            ...
            <div class="card-body">
                ...
                <ul class="list bg-[#0003] rounded-box shadow-md">
                    ...
                    <li class="list-row">
                        ...
                        <button class="btn btn-square btn-ghost">
                            {{ App\Models\Pet::where('adopted', 1)->where('kind', 'Perro')->count() }}
                        </button>
                    </li>
                    <li class="list-row">
                        <div>
                        ...
                        <button class="btn btn-square btn-ghost">
                            {{ App\Models\Pet::where('adopted', 1)->where('kind', 'Gato')->count() }}
                        </button>
                    </li>
                    </ul>
                <div class="card-actions justify-end">

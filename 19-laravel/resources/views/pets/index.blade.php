            ...
            <tbody>
                @foreach ($pets as $pet)
                    <tr class="even:bg-white/5">
                        ...
                        <td>
                            <a href="{{ url('pets/' . $pet->name) }}" class="btn btn-xs btn-outline btn-default">
                                <svg
                            ...
                            <a href="{{ url('pets/' . $pet->name . '/edit') }}" class="btn btn-xs btn-outline btn-default">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg" class="size-4" fill="currentcolor"
                                    viewBox="0 0 256 256">
                                    <path
                            ...
                            <form class="hidden" method="POST" action="{{ url('pets/' . $pet->name) }}">
                                @csrf
                                @method('delete')
                            </form>
                        </td>

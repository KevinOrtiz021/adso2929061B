...
const examples = [
    ...
    { id: 9, title: '09- Challenge',           path: '/challenge', emoji: '🐶', desc: 'Put it all together' },
];
    ...
    <div className="menu">
      ...
      <div className="menu-grid">
        {examples.map((example) => (
          <Link to={example.path} key={example.id} className="menu-card" target={(example.id==9) && '_blank'}>
